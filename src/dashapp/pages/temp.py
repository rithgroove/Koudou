...
from public.css.infection_page import *
    ...
    html.Div([
        ...
        html.Div(
            children=[
                ...
                html.H5(style=style_title, id='datetime-text'),
                dcc.Interval(
                    id='datetime',
                    interval=20*1000,
                    n_intervals=0
        ...
        html.Div(style=style_div_right, children=[
            html.H5(style=style_h4, children="Infection Situation by Time"),
...
def func(n_clicks, ticker):
    return dcc.send_file(
        px.line(df_demo1, x='time_stamp', y=ticker)
    )
