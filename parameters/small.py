parameters = {
    ...
    "MAP":            "osm_files/test.osm", # Path for the osm file used for building the map
    ...
    "N_AGENTS":        50, # Number of agents in the simulation, the more agents, the longer it will take to execute
    "THREADS":         8, # How many CPUs should be used for pathfinding

    "BUILDING_TAGS":  "config/map/building-small.csv", # Path to the file that describes the tags to be created for untagged buildings
    "BUSINESS":       "config/map/business.csv", # Path for the file that describes the open-hours for business
    "GRID_SIZE":      5, # Grid size used when calculating the centroid for buildings, NOT recommended to change
